...
RUN apt update
RUN apt install --yes git curl golang awscli ca-certificates curl gnupg nodejs build-essential --fix-missing
RUN npm install autoprefixer tailwindcss postcss-cli
